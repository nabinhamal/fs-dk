...
import { BsFillBellFill, BsToggles2 } from '../assets/icons';
...
function DBHeader() {
    ...
    return (
    <div className=' w-full flex items-center justify-between gap-3 uppercase'>
        {<p className='text-xl font-semibold text-headingColor hidden md:inline'>Welcome to Daurako Kitchen 
            {user?.name && 
        ...
        <div className="flex items-center justify-center gap-4">
            ...
            <motion.div {...buttonClick} className='w-10 h-10 rounded-full cursor-pointer bg-lightOverlay backdrop-blur-md shadow-md flex items-center justify-center'>
            ...
            <div className="flex items-center justify-center gap-2">
                ...
                {...buttonClick}
                onClick={signOut}
                className= "w-10 h-10 rounded-full  cursor-pointer bg-lightOverlay backdrop-blur-md shadow-md flex items-center justify-center"
                >
