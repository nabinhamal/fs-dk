      ...
      <div className="flex-1 flex flex-col items-start justify-start rounded-t-3xl bg-zinc-900 h-full py-6  gap-3 relative">
        {cart && cart?.length > 0 ? (
          <>
            ...
            <div className="bg-zinc-800 rounded-t-[60px] w-full h-[20%] flex flex-col items-center justify-center px-4 py-6 gap-19">
              ...
              <motion.button
                {...buttonClick}
                className="bg-orange-400 w-[60%] px-4 py-3 text-xl text-headingColor font-semibold hover:bg-orange-500 drop-shadow-md rounded-2xl"
