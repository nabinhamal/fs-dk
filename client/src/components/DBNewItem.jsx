...
const dispatch = useDispatch();
  ...
  const uploadImage = (e) => {
    ...
    {
      /* image upload to firebase and  download*/
    }
  ...
  return (
    <div className="flex items-center justify-center flex-col pt-6 px-24 w-full">
      <div className="border border-gray-300 rounded-md p-4 w-full flex flex-col items-center justify-center gap-4">
        ...
        <div className="w-full bg-card backdrop-blur-md h-370 rounded-md border-2 border-dotted border-gray-50 cursor-pointer">
          {isLoading ? (
            <div className="w-full h-full flex flex-col items-center justify-evenly px-24 ">
              <Spinner />

           {/**  progress image uploading animation*/}
            ...
            <>
              {!imageDownloadURL ? (
                ...
                <div className="w-full h-full relative overflow-hidden rounded-md">
                  ...
                  {...buttonClick}
                  type="button"
                  className="absolute top-3 right-3 p-3 rounded-full bg-red-500 text-xl cursor-pointer outline-none hover:shadow-md duration-500 transition-all ease-linear"
        ...
        {...buttonClick}
        className="w-9/12 py-2 rounded-md bg-red-400 text-primary hover:bg-red-500 cursor-pointer uppercase"
        >
          save
        </motion.button>
      </div>
