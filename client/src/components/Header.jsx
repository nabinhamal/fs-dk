  ...
  return (
    <header className="fixed backdrop-blur-md z-50 inset-x-0 top-0 flex items-center justify-between px-12 md:px-20 py-6">
      ...
      <nav className="flex items-center justify-center gap-5 ">
        <ul className="hidden md:inline  items-center justify-center gap-6 uppercase">
          <NavLink
            className={({ isActive }) =>
        ...
        {user ? (
            ...
            >
              ...
              {isMenu && (
                <motion.div
                  ...
                  className="px-6 py-4 w-48 bg-lightOverlay backdrop-blur-md rounded-md shadow-md absolute top-12 right-0 flex flex-col gap-4 uppercase"
                >
          ...
          <>
            <NavLink to={"/login"}>
              <motion.button
                {...buttonClick}
                className="px-4 py-2 rounded-md shadow-md bg-lightOverlay border border-red-300 cursor-pointer uppercase"
              >
                Login
              </motion.button>
            </NavLink>
